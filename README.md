...
- Choose a user: https://github.com/cgomez374/support-ticketing-system/blob/main/src/data/users.js
- Access Live Web Page: https://support-ticket-web-app.netlify.app

Note: The login credentials in src/data/users.js are fictitious demo data only and are not used for any real accounts or services. Do not reuse these passwords elsewhere; create local, private overrides (e.g., a git-ignored src/data/users.js) if you need custom accounts.
